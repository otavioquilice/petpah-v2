                    ...
                    @foreach($produtos as $produto)
                        ...
                        <a href="/produtosX"><img src="{{ asset('media/imagens/img2/prod'.$produto->id .'.png') }}" alt="item1" class="produto-imagem"><a>
                            <div class="produto-quantidade">
                                ...
                                <div class="produto-quantidade_alinhar">
